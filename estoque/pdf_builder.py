...
def build_pdf(package: Dict[str, Any], commission_pct: float = 13.0) -> bytes:
    ...
    for i, v in enumerate(sorted_votes):
        ...
        # Cálculo exato: Subtotal + comissão variável
        total_comm = subtotal * (1 + float(commission_pct) / 100)
